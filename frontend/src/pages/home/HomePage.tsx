          ...
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                AIStudyPlanner, yapay zeka teknolojisi ile öğrenme stilinize ve hedeflerinize özel
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-20">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 leading-relaxed mt-8">
              AIStudyPlanner'ın yapay zeka destekli özellikleri ile çalışmalarınızı en verimli şekilde planlayın.
