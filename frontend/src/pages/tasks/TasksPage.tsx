        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-sm border border-gray-100 dark:border-gray-700">
          <div className="text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Bu özellik yakında eklenecek! Görevler sayfasında tüm görevlerinizi detaylı bir şekilde görüntüleyebilecek ve yönetebileceksiniz.
            </p>
          </div>
        </div>
=======
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          {(task.description || task.category) && (
                            <div className="hidden group-hover:flex mt-2 text-xs text-gray-500 dark:text-gray-400 bg-gray-50 dark:bg-gray-900/60 rounded-lg px-3 py-2 shadow absolute left-10 top-full z-10 min-w-[200px] max-w-xs">
                              <div>
                                {task.description && (
                                  <div className="mb-1">
