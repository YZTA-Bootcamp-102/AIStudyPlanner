...
const RegisterPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const [first_name, ...lastParts] = formData.fullName.trim().split(' ');
          ...
          <div className="w-full max-w-md bg-white/80 dark:bg-gray-800/80 rounded-2xl p-8 backdrop-blur-sm shadow-[0_8px_30px_rgb(0,0,0,0.12)] dark:shadow-[0_8px_30px_rgba(0,0,0,0.3)]">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <p className="text-center text-sm text-gray-600 dark:text-gray-400 mt-8">
                ...
                <Link to="/login" className="font-medium text-orange-500 hover:text-orange-600 dark:hover:text-orange-400">
                  Giriş yapın
                </Link>
              </p>
            </form>
