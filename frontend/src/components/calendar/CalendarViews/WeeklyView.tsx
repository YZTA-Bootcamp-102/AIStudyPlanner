                            ...
                            return (
                              <div
                                ...
                                className={`
                                  ...
                                  z-10 text-xs
                                  ${priorityColors[task.priority as PriorityType].bg} border-l-2 ${priorityColors[task.priority as PriorityType].border}
                                `}
                                style={{ top, height, width, left }}
                              >
                                <div className="h-full overflow-hidden">
                                  <h4 className={`font-semibold truncate ${priorityColors[task.priority as PriorityType].text}`}>
                                    {task.title}
                                  </h4>
                                  {parseInt(height) >= 40 ? (
