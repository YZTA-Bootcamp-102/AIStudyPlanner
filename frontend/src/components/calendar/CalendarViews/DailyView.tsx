              ...
              <div
                ...
                className={`
                  absolute p-2 rounded-lg shadow-lg transition-all
                    ...
                    ${priorityColors[task.priority].bg} border-l-4 ${priorityColors[task.priority].border}
                `}
              >
                <div className="h-full overflow-hidden">
                  <h4 className={`font-semibold text-sm truncate ${priorityColors[task.priority].text}`}>
                    {task.title}
                  </h4>
                    {height >= 50 ? (
